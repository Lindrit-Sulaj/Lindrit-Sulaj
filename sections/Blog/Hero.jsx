...
export default function Hero() {
  return (
    <section className='mt-[70px] bg-byzantine-blue pt-10 pb-20 flex justify-center flex-col items-center px-12 md:px-20'>
      ...
      <div className=' mt-6 w-full max-w-xl mx-auto flex justify-center md:gap-4 gap-2 px-4'>
