...
const articles = [
  { 
    ...
    "description": "Discover how APIs are crucial to modern web development and learn the different types of APIs.", 
    "date": "August 4", 
    "minutesToRead": 3, },
  { 
    "category": "SEO", 
    "color": 'rgb(4 120 87)', 
    "title": "10 Common SEO Mistakes to Avoid", 
    "description": "Learn how to avoid common mistakes that can hurt your website's search rankings on search engines.", 
    "date": "July 18, 2022", 
    "minutesToRead": 5 },
  { "category": "SEO", "color": 'rgb(4 120 87)', "title": "5 Common SEO Mistakes to Avoid", "description": "Learn how to avoid common mistakes that can hurt your website's search engine rankings.", "date": "November 20", "minutesToRead": 6 },
  { "category": "Web Development", "title": "Introduction to Responsive Web Design", "color": 'rgb(5 74 218)', "description": "Discover the basics of responsive web design and why it's important for modern websites.", "date": "October 8", "minutesToRead": 10 },]
