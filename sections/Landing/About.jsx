...
export default function About() {
  return (
    <section>
      <div className='max-w-screen-web mx-auto py-20 md:py-32 px-10 lg:px-6 xl:px-0 flex justify-around flex-wrap md:flex-nowrap gap-x-10 gap-y-14 items-center'>
