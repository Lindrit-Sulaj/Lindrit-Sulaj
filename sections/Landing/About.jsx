    ...
    <section id="about">
      <div className='max-w-screen-web mx-auto py-20 md:py-32 px-6 md:px-10 lg:px-6 xl:px-0 flex justify-center md:justify-between flex-wrap md:flex-nowrap gap-x-10 gap-y-14 items-center'>
        <div className='w-full md:w-1/2'>
          ...
          <p className='text-[17px] mt-6 lg:text-lg text-neutral-600'>Hi there, I'm a 15-year-old web developer based in Kosovo. I discovered my passion for programming two years ago and have been working tirelessly to improve my skills ever since. In my free time I like to create visually stunning websites.</p>
